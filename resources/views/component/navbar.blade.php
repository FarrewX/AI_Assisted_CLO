    ...
    <nav class="w-full bg-white shadow-sm" x-data="{ open: false }">
        <div class="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ url('/profile') }}" 
                class="hidden md:flex w-8 h-8 items-center justify-center rounded-full bg-gray-200 hover:bg-gray-300">
        ...
        >
            ...
            >
                ...
                <nav class="space-y-4 mt-8">
                    ...
                    <a href="{{ url('/profile') }}" class="flex w-10 h-10 items-center justify-center rounded-full bg-gray-200 hover:bg-gray-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" 
