...
<body class="font-sans antialiased">
    <div id="tqf-form-container" class="flex justify-center py-6 font-sans text-bases">
            ...
            <div class="justify-center mb-2 text-[16px]">
                ...
                <div id="section-7-container">
                    ...
                    <div class="mb-4 flex items-center gap-2">
                        ...
                        <div class="ml-auto gap-3 px-3 py-1.5 flex items-center">
                            <button id="generateLessonTableBtn" class="px-3 py-1.5 bg-orange-500 text-white text-xs font-semibold rounded hover:bg-orange-600 shadow-sm transition-colors flex items-center"
                                >Ai เจนข้อมูล
                            </button>
